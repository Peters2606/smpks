    ...
    <form wire:submit.prevent="save">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
            <div class="col-span-1">
                ...
                <input type="text" id="pks_number_partner" wire:model="pks_number_partner" class="block w-full px-4 py-2 border border-gray-300 rounded-lg shadow-sm focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm placeholder-gray-400 transition duration-150 ease-in-out">
            ...
            <div class="col-span-1">
                ...
                <input type="text" id="pks_number_hospital" wire:model="pks_number_hospital" class="block w-full px-4 py-2 border border-gray-300 rounded-lg shadow-sm focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm placeholder-gray-400 transition duration-150 ease-in-out">
            ...
            <div class="md:col-span-2">
                ...
                <input type="text" id="contract_name" wire:model="contract_name" class="block w-full px-4 py-2 border border-gray-300 rounded-lg shadow-sm focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm placeholder-gray-400 transition duration-150 ease-in-out">
            ...
            <div class="col-span-1">
                ...
                <input type="date" id="start_date" wire:model="start_date" class="block w-full px-4 py-2 border border-gray-300 rounded-lg shadow-sm focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm transition duration-150 ease-in-out">
            ...
            <div class="col-span-1">
                ...
                <input type="date" id="end_date" wire:model="end_date" class="block w-full px-4 py-2 border border-gray-300 rounded-lg shadow-sm focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm transition duration-150 ease-in-out">
            ...
            <div class="col-span-1">
                ...
                <input type="number" id="tariff_year" wire:model="tariff_year" placeholder="Contoh: 2024" class="block w-full px-4 py-2 border border-gray-300 rounded-lg shadow-sm focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm placeholder-gray-400 transition duration-150 ease-in-out">
            ...
            <div class="md:col-span-2">
                <label for="is_new_contract" class="inline-flex items-center mt-2 cursor-pointer">
                    <input type="checkbox" id="is_new_contract" wire:model="is_new_contract" class="rounded border-gray-300 text-indigo-600 shadow-sm focus:ring-indigo-500 transition duration-150 ease-in-out">
